...
const PlaceSections = () => {
  ...
  return (
    ...
    //                     <Link to={"#"}>Hotel Plaza Athenee</Link>
    //                   </h5>
    ...
    //                   </div>
    //                   <h5 className="mb-1 text-truncate">
    //                     <Link to={"#"}>The Grand Horizon</Link>
    //                   </h5>
    //                   <p className="d-flex align-items-center mb-2">
    //                     <i className="isax isax-location5 me-2" />
    ...
    //                   </div>
    //                   <h5 className="mb-1 text-truncate">
    //                     <Link to={"#"}>The Urban Retreat</Link>
    //                   </h5>
    //                   <p className="d-flex align-items-center mb-2">
    //                     <i className="isax isax-location5 me-2" />
    ...
    //                             </div>
    //                             <h5 className="text-truncate mb-1">
    //                                 <Link to={"#"}>Aether Express 901</Link>
    //                             </h5>
    //                             <div className="d-flex align-items-center mb-2">
    //                                 <span className="avatar avatar-sm me-2">
    //                                     <ImageWithBasePath
    ...
    //                                 </div>
    //                             </div>
    //                             <h5 className="mb-1 text-truncate"><Link to={"#"}>Toyota Camry SE 400</Link></h5>
    ...
    //                                 </div>
    //                             </div>
    //                             <h5 className="mb-1 text-truncate"><Link to={"#"}>Ford Mustang 4.0 AT</Link></h5>
    ...
    //                                 </div>
    //                             </div>
    //                             <h5 className="mb-1 text-truncate"><Link to={"#"}>Ferrari 458 MM Special</Link></h5>
    ...
    //                                 </div>
    //                             </div>
    //                             <h5 className="mb-1 text-truncate"><Link to={"#"}>BMW 3.0 Gran Turismo</Link></h5>
    ...
    //                                 </div>
    //                             </div>
    //                             <h5 className="mb-1 text-truncate"><Link to={"#"}>Infiniti QX60 </Link></h5>
    ...
    //                                 </div>
    //                             </div>
    //                             <h5 className="mb-1 text-truncate"><Link to={to={"#"}}>Super Aquamarine</Link></h5>
    //                             <p className="d-flex align-items-center mb-3"><i className="isax isax-location5 me-2"></i>Ciutat Vella, Barcelona</p>
    ...
    //                                 </div>
    //                             </div>
    //                             <h5 className="mb-1 text-truncate"><Link to={to={"#"}}>Bonnie Yacht</Link></h5>
    //                             <p className="d-flex align-items-center mb-3"><i className="isax isax-location5 me-2"></i>Oxford Street, London</p>
    //                             <div className="d-flex justify-content-between align-items-center mb-3">
    //                                 <div>
    ...
    //                                 </div>
    //                             </div>
    //                             <h5 className="mb-1 text-truncate"><Link to={to={"#"}}>Coral Cruiser</Link></h5>
    //                             <p className="d-flex align-items-center mb-3"><i className="isax isax-location5 me-2"></i>Princes Street, Edinburgh</p>
    //                             <div className="d-flex justify-content-between align-items-center mb-3">
    //                                 <div>
    //                                     <p className="mb-1"><i className="isax isax-calendar-2 text-gray-6 me-1"></i>Year : <span className="text-dark fw-medium">2021</span></p>
    ...
    //                                 </div>
    //                             </div>
    //                             <h5 className="mb-1 text-truncate"><Link to={to={"#"}}>Harbor Haven</Link></h5>
    //                             <p className="d-flex align-items-center mb-3"><i className="isax isax-location5 me-2"></i>Princes Street, Edinburgh</p>
    //                             <div className="d-flex justify-content-between align-items-center mb-3">
    //                                 <div>
    ...
    //                                 </div>
    //                             </div>
    //                             <h5 className="mb-1 text-truncate"><Link to={to={"#"}}>Albert Yacht</Link></h5>
    //                             <p className="d-flex align-items-center mb-3"><i className="isax isax-location5 me-2"></i>King’s Road, Chelsea</p>
    //                             <div className="d-flex justify-content-between align-items-center mb-3">
    //                                 <div>
    ...
    //             <Link to={"#"} className="btn btn-dark d-inline-flex align-items-center">View All Places<i className="isax isax-arrow-right-3 me-2"></i></Link>
    //         </div>
    //     </div>
    // </section>
    <div className="">PlaceSections Home One</div>
  );
};
