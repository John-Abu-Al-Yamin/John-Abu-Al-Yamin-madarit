          ...
          <div className="row">
            ...
            <div className="col-xl-9 col-lg-8">
              <div className="alert alert-teal alert-dismissible d-flex align-items-center border-0 mb-4 fade show">
                <i className="isax isax-info-circle5 me-2" /> Reminder about
                your upcoming booking Hotel Hayat on 15 May 2025 at 09:30 AM .
                  ...
                  <div className="card shadow-none flex-fill">
                    <div className="card-body">
                      ...
                      <div className="d-flex justify-content-between align-items-center mb-4">
                        ...
                        <Link to={"#"} className="btn rebook-btn btn-sm">
                      ...
                      <div className="d-flex justify-content-between align-items-center mb-4">
                        <div className="d-flex align-items-center">
                          ...
                          <div>
                            <h6 className="fs-16">
                              <Link to={"#"}>Ford Mustang 4.0 AT</Link>{" "}
                    ...
                    <div className="card-body">
                      ...
                      <div className="d-flex align-items-center mb-3">
                        ...
                        <div className="flex-fill overflow-hidden">
                          ...
                          <p className="fs-14 two-line-ellipsis">
                            Your{" "}
                            <span className="fw-medium">Mountain Valley</span>{" "}
                      ...
                      <div className="d-flex align-items-center mb-3">
                        ...
                        <div className="flex-fill overflow-hidden">
                          ...
                          <p className="fs-14 two-line-ellipsis">
                            Your Hotel Booking of Suite Room on 15 Jan 2025 has
                            been rescheduled to 20 May 2025.
                          </p>
                        </div>
                      </div>
                      <div className="d-flex align-items-center mb-3">
                        ...
                        <div className="flex-fill overflow-hidden">
                          ...
                          <p className="fs-14 two-line-ellipsis">
                            Thank you for choosing Air India. Your adventure is
                            set for 21 Jan 2025 at 04:45 PM.{" "}
                          </p>
                        </div>
                      </div>
                      <div className="d-flex align-items-center">
