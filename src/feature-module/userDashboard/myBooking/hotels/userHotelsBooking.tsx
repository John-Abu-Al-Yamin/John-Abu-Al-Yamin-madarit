...
import { UserHotelBookingData } from '../../../../core/common/data/json/userHotelBookingData';
import UserHotelsBookingModal from './userHotelsBookingModal';
...
const UserHotelsBooking = () => {
  ...
  const data = UserHotelBookingData;
  const columns = [
    {
      title: "ID",
      dataIndex: "id",
    ...
    },
    {
      ...
      dataIndex: "bookedOn",
      key: "bookedOn",
      sorter: (a: TableData, b: TableData) => a.bookedOn.length - b.bookedOn.length,
    },
    {
      title: "Status",
      dataIndex: "status",
