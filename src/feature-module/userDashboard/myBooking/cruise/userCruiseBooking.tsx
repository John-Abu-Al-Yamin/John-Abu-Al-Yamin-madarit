...
import { UserCruiseBookingData } from '../../../../core/common/data/json/userCruiseBookingData';
import UserCruiseBookingModal from './userCruiseBookingModal';
...
const UserCruiseBooking = () => {
  ...
  const data = UserCruiseBookingData;
  const columns = [
    {
      title: "ID",
      dataIndex: "id",
    ...
    },
    {
        ...
        <div className="d-flex align-items-center">
          ...
          <div className="ms-2">
            <p className="text-dark mb-0 fw-medium fs-14">
              <Link to={"#"}>{render.cruisename}</Link>
            </p>
      ...
      sorter: (a: TableData, b: TableData) =>
        a.cruisename.length - b.cruisename.length,
    },
    {
      title: "Cabin & Guest",
      dataIndex: "cabin",
      ...
      render: (text: any, render: any) => (
        <>
          <h6 className="fs-14 mb-1">{render.cabin}</h6>
          <span className="fs-14 fw-normal text-gray-6">{render.members}</span>
        </>
      ),
      sorter: (a: TableData, b: TableData) => a.cabin.length - b.cabin.length,
    },
    {
      title: "Days",
      dataIndex: "day",
