...
import { UserCarBookingData } from '../../../../core/common/data/json/userCarBookingData';
import UserCarBookingModal from './userCarBookingModal';
...
const UserCarBooking = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      key: "travellers",
      sorter: (a: TableData, b: TableData) => a.travellers.length - b.travellers.length,
    },
    {
      title: "Days",
      dataIndex: "day",
